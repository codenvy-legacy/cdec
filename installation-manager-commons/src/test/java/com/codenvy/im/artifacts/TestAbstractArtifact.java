...
public class TestAbstractArtifact {
    ...
    public void testValidateProperties() throws Exception {
        ...
        doReturn("{\"version\":\"1.0.0\", \"file\":\"file1\", \"md5\":\"a\", \"build-time\":\"01.01.01\", \"artifact\":\"" + TEST_ARTIFACT_NAME + "\", \"size\":456, \"authentication-required\":false}")
            .when(mockTransport)
            .doGet(endsWith("repository/properties/" + TEST_ARTIFACT_NAME));
    ...
    public void testGetDownloadedVersions() throws IOException {
        doReturn("{\"file\":\"file1\", \"md5\":\"d41d8cd98f00b204e9800998ecf8427e\"}").when(mockTransport).doGet(endsWith(TEST_ARTIFACT_NAME + "/1.0.1"));
        doReturn("{\"file\":\"file2\", \"md5\":\"d41d8cd98f00b204e9800998ecf8427e\"}").when(mockTransport).doGet(endsWith(TEST_ARTIFACT_NAME + "/1.0.2"));
    ...
    class AbstractArtifactTest extends AbstractArtifact {
        ...
        @Override protected Path getInstalledPath() throws URISyntaxException {
            throw new UnsupportedOperationException();
        }

        @Override public void install(Path pathToBinaries, @Nullable InstallOptions options) throws IOException {
            throw new UnsupportedOperationException();
        }

        @Nullable @Override public Version getInstalledVersion(String authToken) throws IOException {
            throw new UnsupportedOperationException();
        }
