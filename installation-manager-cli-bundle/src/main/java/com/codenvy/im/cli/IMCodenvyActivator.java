 ...
 * By doing this, this avoid to either have : Karaf with delay console flag or to use command in shell.init scripts that failed as command is not
 * there.
 *
 * @author Florent Benoit
 */
public class IMCodenvyActivator implements BundleActivator {

    /** Logger. */
    private static final Logger LOGGER = Logger.getLogger(IMCodenvyActivator.class.getName());

    /** Switch command. */
    private static final String SWITCH_COMMAND = "default-im-namespace";
