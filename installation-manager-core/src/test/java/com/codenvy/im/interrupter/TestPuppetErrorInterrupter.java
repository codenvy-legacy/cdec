...
public class TestPuppetErrorInterrupter {
    public static final int WAIT_INTERRUPTER_MILLIS = PuppetErrorInterrupter.READ_LOG_TIMEOUT_MILLIS * 5;
    @Mock
    Interruptable testInterruptable;

    PuppetErrorInterrupter testInterrupter;

    File   testPuppetLog           = new File("target/test-classes/messages");
    ...
    public void createLogFile() throws IOException {
        FileUtils.write(testPuppetLog, logWithoutErrorMessages);
    }
    ...
    public void testInterruptWhenAddError() throws InterruptedException, IOException {
        ...
        FileUtils.write(testPuppetLog, errorMessage, true);
        Thread.sleep(WAIT_INTERRUPTER_MILLIS);
