...
public class CommandLibrary {
    ...
    /**
     * @return for certain node, the command "sudo tar -C {fromDir} -fr {packFile} {pathWithinThePack}", if packFile exists, or
     * command "sudo tar -C {fromDir} -fc {packFile} {pathWithinThePack}", if packFile doesn't exists.
     *
     * Don't gzip to be able to update pack in future.
     */
